  ...
  const getDetailProduk = async () => {
    try {
      ...
      setTimeout(() => {
        ...
        console.log(response.data.data.gambarProduk);
        const obj = JSON.parse(json);
        setObj(obj);
        console.log(obj[0].gambar1);
        console.log(obj[1].gambar2);
      }, 2000);
    } catch (error) {
    } finally {
      setloading(true);
        ...
        <div>
          ...
          <div className="mt-5 ml-5 flex space-x-5">
            <div className="border-green-500 border w-[500px] h-[400px] rounded-lg overflow-hidden">
              {/* <img src={obj[1].gambar2} className="h-full w-full"  alt="gambar"/> */}
            </div>
            ...
            <div>
              ...
              <h1 className="font-sans text-lg text-green-500">
              ...
              <h1 className="mt-5 mb-4 font-bold  text-green-500">
                DESKRIPSI :
              </h1>
              ...
              <div className="space-x-5 mt-10">
                <button className="border-2 w-[150px] h-[30px] bg-transparent border-green-500 outline-none rounded-lg text-white font-bold text-lg">
                  Buy
                </button>
                <button className="border-2 w-[150px] h-[30px] bg-transparent border-green-500 outline-none rounded-lg text-white font-bold text-lg">
                  Cart
